          ...
          SliverAppBar(
            ...
            actions: [
              ...
              InkWell(
                ...
                child: Image.asset(_showTitle ?Assets.imagesRupeesWhite:Assets.imagesRupeesBlue,scale: 2.5,),
              ),
              SizedBox(
                width: width * 0.04,
              ),
                        ...
                        children: [
                          ...
                          Stack(
                            ...
                            children: [
                              ...
                              CustomContainer(
                                onTap: (){
                                  Navigator.pushNamed(context, RoutesName.ludoSupreme);
                                },
                                height: height * 0.07,
                                widths: width * 0.5,
                                alignment: Alignment.center,
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: const BoxDecoration(
                                      color: Colors.red,
                                      image: DecorationImage(image: AssetImage(Assets.imagesMoneyApps),fit: BoxFit.fill),
                                      borderRadius:
                                      BorderRadius.all(Radius.circular(25))),
                                  child: Padding(
                                    padding:
                                    const EdgeInsets.only(left: 19.0, bottom: 15),
                                    child: Container(
                                      alignment: Alignment.center,
                                      height: height * 0.05,
                                      width: width * 0.35,
